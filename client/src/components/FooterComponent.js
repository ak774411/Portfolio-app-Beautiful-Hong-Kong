            ...
            <div className="container">
                <div className="row justify-content-center">             
                    <div className="col-4 offset-1 col-sm-2">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li style={{ color:white }}><Link to="/aboutus">About Us</Link></li>
                            <li style={{ color:white }}><Link to="/menu">Menu</Link></li>
                            <li style={{ color:white }}><Link to="/contactus">Contact Us</Link></li>
                        </ul>
                    </div>
                ...
                <div className="row justify-content-center">             
                    <div className="col-auto">
                        <p>© Copyright 2021 chengyuenming.com</p>
                    </div>
                </div>
            </div>
        </div>
